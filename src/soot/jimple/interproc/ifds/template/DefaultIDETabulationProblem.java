 ...
 */
public abstract class DefaultIDETabulationProblem<D extends UpdatableWrapper<?>,V,
	I extends InterproceduralCFG<UpdatableWrapper<Unit>, UpdatableWrapper<SootMethod>>>
		extends DefaultIFDSTabulationProblem<D,I>
		implements IDETabulationProblem<UpdatableWrapper<Unit>, D, UpdatableWrapper<SootMethod>, V, I>{

	private final EdgeFunction<V> allTopFunction;
	private final JoinLattice<V> joinLattice;
	private final EdgeFunctions<UpdatableWrapper<Unit>,D,UpdatableWrapper<SootMethod>,V> edgeFunctions;
	...
	protected abstract EdgeFunctions<UpdatableWrapper<Unit>, D, UpdatableWrapper<SootMethod>, V> createEdgeFunctionsFactory();
	...
	@Override
	public final EdgeFunctions<UpdatableWrapper<Unit>, D, UpdatableWrapper<SootMethod>, V> edgeFunctions() {
